...
#***************************************************************************
train_step = tf.train.AdagradOptimizer(1.0).minimize(loss)
...
with tf.Session() as sess:
    ...
    summary_writer= tf.summary.FileWriter('./graphs/auto_loss',graph=tf.get_default_graph())#******************
    ...
    for i in range(6001):
        ...
        summary_writer.add_summary(summary, i*6000)
